...
export class IntelligenceMCPService implements IntelligenceMCP {
  ...
  constructor() {
    ...
    this.perplexityApiKey = apiKeyManager.getKeyValue('perplexity') || '';
    this.perplexityUrl = apiKeyManager.getApiUrl('perplexity') || 'https://api.perplexity.ai/chat/completions';
